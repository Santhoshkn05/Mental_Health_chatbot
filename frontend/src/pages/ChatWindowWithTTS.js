...
import { Brain, Send, Mic, MicOff, User, Bot, Volume2, VolumeX } from "lucide-react";

const ChatWindowWithTTS = ({ activeSessionId, sessions, setSessions, theme, defaultQueries, isSidebarOpen }) => {
  ...
  // 🔥 PHASE 6: TEXT-TO-SPEECH FUNCTIONALITY
  const speakText = (text) => {
    ...
    try {
      ...
      utterance.rate = 0.9; // Slightly slower for mental health
  ...
  useEffect(() => {
    console.log('TTS ChatWindow Debug:', {
      currentSession,
      activeSessionId,
  ...
  // 🔥 ENHANCED MESSAGE SENDING WITH TTS
    ...
    if (!isListening) {
      try {
        ...
        mediaRecorder.current.onstop = () => {
          ...
          // Convert to text and set as input
...
export default ChatWindowWithTTS;
